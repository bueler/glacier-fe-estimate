...
Theorem \ref{thm:glacierapp}, our main result to come, is numerical as it bounds the FE error in surface elevation.  It is based upon an extension of an abstract technique from Falk \cite{Falk1974} to a large class of nonlinear operators.  It is tied to the concepts of monotonicity \cite{Minty1963} and coercivity \cite[Chapter III]{KinderlehrerStampacchia1980}.
...
In the $\qq=2$ case, $\qq$-coercivity is sometimes called \emph{strong monotonicity} \cite{Chow1989}.  It implies coercivity and strict monotonicity.
