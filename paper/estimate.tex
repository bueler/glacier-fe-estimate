...
and fractures do not occur within the viscous-fluid physics of such models.  We will follow these conventions.  Future models might allow fractures, supplementing momentum conservation with an advected damage variable and a stress-failure criterion \cite{PralongFunk2005}.  Averaged over hundred-meter scale, the emergent margin shapes might suggest a regularity assumption and Sobolev space for surface elevations in the viscous theory.
