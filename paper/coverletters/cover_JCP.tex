...
\noindent To the Editor of the Journal of Computational Physics --

\bigskip

\noindent  Please consider this manuscript for publication in JCP.  This is an original submis-
sion, with a preprint posted at \href{https://arxiv.org/abs/2408.06470}{arxiv.org/abs/2408.06470}.

\medskip
\noindent  This work contains new results both in glacier ice modeling and numerical analysis.  It addresses the quality of finite element solutions of the fundamental free-boundary problem which determines the extent of glaciation.  It contains a new and general finite element quasi-optimality result for variational inequalities (VIs), permitting a non-linear operator.  The most original and significant content may be the precise formulation of the weak-form mathematical model for glacier evolution using Stokes non-shallow dynamics, which is a variational inequality.  Although I make rigorous progress on the model, and prove that the finite element solution is close to the continuum model, well-posedness is nonetheless based on conjectural elements, which I make very clear.

\medskip
\noindent  Researchers with an interest in ice physics and glaciers, plus those who study other VI and/or Stokes models for fluids, are in the target audience.

\medskip
\noindent  There are relatively few mathematical glaciologists out there, but here are some referee suggestions, listed alphabetically, supposing suggestions are appropriate:
\begin{itemize}
