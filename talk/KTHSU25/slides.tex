...
{\small
\begin{itemize}
\item you won't pass your ``numerical methods for stiff differential equations'' course if you blindly recommend explicit methods for the infinitely-stiff limit, which are DAEs
\end{itemize}
}
\end{frame}
